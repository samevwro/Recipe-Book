...
//this is the starting recipes that will always be there when the page is refreshed
...
function App() {
  ...
  //This is where all the information from the add recipe form is collected to be compiled then added to state
  function AddRecipe() {
  ...
  //When the favorite button is pressed it takes the selected recipe
  //then changes the favorite property in the object to the opposite of what it's set at
  ...
  //so they can be correctly id'd when rendered and open the correct data to it
